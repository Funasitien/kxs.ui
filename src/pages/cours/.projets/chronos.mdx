---
title: "Projet Chronos - Dessiner automatiquement une frise chronologique"
...
Nous utiliserons le format SVG ([Scalable Vector
Graphics](https://fr.wikipedia.org/wiki/Scalable_Vector_Graphics)) qui permet
de faire du [dessin
vectoriel](https://fr.wikipedia.org/wiki/Image_vectorielle). L'avantage du SVG
est qu'il est au format texte. Il est donc relativement facile de créer un
...
1961 : Astérix le Gaulois 1962 : La serpe d'or 1964 : Astérix gladiateur  1966
: Astérix chez les Bretons 1973 : Astérix en Corse 1980 : Le grand fossé 1987
: Astérix chez Rahàzade  1996 : La galère d'Obélix 2005 : Le ciel lui tombe
sur la tête 2013 : Astérix chez les Pictes 24 Novembre 2019 : La Fille de
Vercingétorix

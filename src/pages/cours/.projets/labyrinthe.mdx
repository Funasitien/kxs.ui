---
title: "Projet : Labyrinthe - Niveau terminale"
...
L'objectif principal est de trouver un chemin en utilisant [l'algorithme de
recherche de chemin](/cours/graphes/algo-graphes#chemin) vu précédement. Il y

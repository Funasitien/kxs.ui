...
![Logo de Thonny](/public/Thonny.png) Licence MIT

Lancez donc Thonny pour commencer à écrire des instructions Python.

![Fenêtre de Thonny](/public/Thonny2.png) Auteur : Thomas Beline | [Attribution - Partage dans les Mêmes Conditions 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/deed.fr)

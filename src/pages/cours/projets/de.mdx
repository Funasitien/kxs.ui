...
<center>![JusteUnDe](/cours/de.png)</center>
...
Pour commencer, vous pouvez créer une fonction `cercle(x, y, r)` qui trace un cercle de centre (x, y) et de rayon r. Attention ! Turtle a une façon très particulière de tracer les cercles.

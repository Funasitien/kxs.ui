...
![](/cours/pixel-example.png) 
Auteur : ed g2s | [source](https://upload.wikimedia.org/wikipedia/commons/2/2b/Pixel-example.png) | [Attribution - Partage dans les Mêmes Conditions 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/deed.fr)

...
httpsle protocole, il est avant le séparateur. Dans le cas du web il sera toujours http ou https ;
://le séparateur ;
www.debian.orgle nom de domaine/sous-domaine. Il se situe entre le séparateur et le premier / ;
/intro/aboutle chemin vers la ressource.

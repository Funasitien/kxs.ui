...
![Iris Setosa](img/iris_setosa.jpg)![Iris
Virginica](img/iris_virginica.jpg)![Iris Versicolor](img/iris_versicolor.jpg)
...
plusieur fleurs appartenant aux trois catégories](img/plot1.png)
...
encore une nouvelle fleur](img/plot2bis.png)
...
![Application de l'algorithme des trois plus proches voisisns](img/plot3.png)
...
[Précédent](algorithmes-gloutons)[Suivant](choixpeau)

...
[Langage compilé vs interprété](https://leblogducodeur.broken/langage-compile-vs-interprete/) : Article de blog expliquant simplement les différences entre les deux types de langage.

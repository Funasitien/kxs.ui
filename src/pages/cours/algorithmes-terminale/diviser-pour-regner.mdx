...
## Algorithmes
  ...
  * [Introduction](.)
  * [Diviser pour régner](diviser-pour-regner)
...
tourner sera [la joconde](img/joconde.png). Elle est carrée avec une taille
...
[Précédent](.)[Suivant](programmation-dynamique)

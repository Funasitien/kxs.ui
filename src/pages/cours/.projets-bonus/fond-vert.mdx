...
La documentation de Pillow est disponible à l’adresse suivante :
...
vert](img/vald.jpg). Et l'image à incruster est une salle de classe :
[classe](img/classe.jpg). Les deux images font la même taille pour faciliter

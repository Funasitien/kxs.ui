...
## Architectures matérielles
  ...
  * [Introduction](.)
  * [Von Neumann et langage machine](vonneumann)
  * [Réseau](reseau)
  * [TCP/IP](tcpip)
...
![Bit alterné quand tout va bien](img/bitalt1.png) Auteur : David Roche | [source](https://pixees.fr/informatiquelycee/n_site/nsi_prem_bit_alt.html) | [Attribution - Partage dans les Mêmes Conditions 3.0 non transposé](https://creativecommons.org/licenses/by-sa/3.0/deed.fr)
...
![Bit alterné avec une trame perdue](img/bitalt2.png) Auteur : David Roche | [source](https://pixees.fr/informatiquelycee/n_site/nsi_prem_bit_alt.html) | [Attribution - Partage dans les Mêmes Conditions 3.0 non transposé](https://creativecommons.org/licenses/by-sa/3.0/deed.fr)

Cela peut aussi arriver si l’accusé de réception est perdu :

![Bit alterné avec un accusé de réception perdu](img/bitalt3.png) Auteur : David Roche | [source](https://pixees.fr/informatiquelycee/n_site/nsi_prem_bit_alt.html) | [Attribution - Partage dans les Mêmes Conditions 3.0 non transposé](https://creativecommons.org/licenses/by-sa/3.0/deed.fr)
...
[Précédent](reseau)[Suivant (page des cours)](..)
